...
int main(int argc, char **argv) {
	...
	uint64_t fbBase = (uint64_t) final_gop.base_address;
	uint64_t fbSize = (uint64_t) final_gop.buffer_size + 0x1000;
    ...
    int r = (*((int(* __attribute__((sysv_abi)))(bamboo_boot_info_t*))(entry + KERNEL_START)))(&boot_info);
